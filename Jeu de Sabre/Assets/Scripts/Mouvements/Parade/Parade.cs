...
namespace Mouvements.Parade
{
    public class Parade : MonoBehaviour
    {
        ...
        private bool isParade = false;
        private bool isReady = true;

        public void Init(float timer, GameObject fx1, GameObject fx2, GameObject fxPos, GameObject katanaAxis,
            Player.Joueur player, KatanaOrientation katanaOrientation)
        {
            this.player = player;
            this.timer = timer;
            fxParade1 = fx1;
